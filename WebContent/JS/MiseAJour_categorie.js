...
function supprimerProposition(numeroGroupe, numeroQuestion, numeroPropositionASupprimer)
{
	...
	var parametresQuestion = question.children;
  	...
  	var numeroProposition = 0, check = false, propositionASupprimer;
  	var nbElements = (document.getElementById("question" + numeroQuestion + "proposition" + (numeroProposition + 1) + "_id"  ) == null ) ? 4 : 5;
	var k = (document.getElementById("question" + numeroQuestion + "_id") == null ) ? 9 : 11;
  	while( (k + (nbElements - 1) ) <  parametresQuestion.length)//Cette question a des propositions ?
  	{
	  	numeroProposition++;
	  	...
	  	k += nbElements;
	  	nbElements = (document.getElementById("question" + numeroQuestion + "proposition" + (numeroProposition + 1) + "_id") == null ) ? 4 : 5;
  	}
		...
		for(var i = numeroGroupe ; i < nbGroupes ; i++)
		{
		  ...
		  for (var j = 2; j < questions.length ; j++) {
			  	...
			  	if(check == true)
			  	{
			  		...
			  		var questionIsInBdd = (document.getElementById("question" + numeroQuestionI + "_id") == null ) ? false : true;

			  		var question = document.getElementById("question_" + (numeroQuestionI) );
				  	var parametresQuestion = question.children;
				  	
				  	var z;
				  	if(questionIsInBdd)
				  	{
				  		parametresQuestion[0].innerHTML = 'Question n°' + numeroQuestionNouveau + parametresQuestion[0].innerHTML.substr( parametresQuestion[0].innerHTML.search("<a") );
				  		parametresQuestion[1].id = "question" + numeroQuestionNouveau + "_id";
				  		parametresQuestion[1].name = parametresQuestion[1].id;
				  		z = 2;
				  	}
				  	else
				  	{
				  	...
				  	/* élément <select> */
				  	parametresQuestion[z].name = "question_type_q" + numeroQuestionNouveau + "_g" + i;
				  	parametresQuestion[z].id = parametresQuestion[z].name;
				  	z++;
				  	
					/*  <input type="text" id="question_texte_q1_g1" name="question_texte_q1_g1" placeholder="La question présentée aux utilisateurs" /> */
				  	parametresQuestion[z].name = "question_texte_q" + numeroQuestionNouveau + "_g" + i;
				  	parametresQuestion[z].id = parametresQuestion[z].name;
				  	z += 2;

					/* <label for="champ_obligatoire_q3_g2">Oui</label> */
				  	parametresQuestion[z].htmlFor = "champ_obligatoire_q" + numeroQuestionNouveau + "_g" + i;
				  	z++;

					/* <input type="radio" id="champ_obligatoire_q3_g2" name="question_obligatoire_q3_g2" value="1" /> */
				  	parametresQuestion[z].name = "question_obligatoire_q" + numeroQuestionNouveau + "_g" + i;
				  	parametresQuestion[z].id   = "champ_obligatoire_q" + numeroQuestionNouveau + "_g" + i;
				  	z++;

				  	/*  <label for="champ_pas_obligatoire_q3_g2">Non</label> */
				  	parametresQuestion[z].htmlFor = "champ_pas_obligatoire_q" + numeroQuestionNouveau + "_g" + i;
				  	z++;

					/*  <input type="radio" id="champ_pas_obligatoire_q3_g2" name="question_obligatoire_q3_g2" value="0"  />  */
				  	parametresQuestion[z].name = "question_obligatoire_q" + numeroQuestionNouveau + "_g" + i;
				  	parametresQuestion[z].id   = "champ_pas_obligatoire_q" + numeroQuestionNouveau + "_g" + i;
				  	z++;
					
				  	/* <input type="button" id="question_3_ajouteProposition" value=" + Proposition" onclick="ajouteProposition();" />  */			  	
				  	parametresQuestion[z].innerHTML = "Les champs qui seront affichés aux utilisateurs pour répondre à cette question <br />" ;
				  	parametresQuestion[z].innerHTML += '<input id="question_' + numeroQuestionNouveau + '_ajouteProposition" value=" + Proposition" type="button" onclick="ajouteProposition(' + i + ' , ' + numeroQuestionNouveau + ');" /> \n' ;     
				  	
				  	if(questionIsInBdd)
				  		z++; // <script> initArray(1 , 0);</script>

				  	var k = (z + 1)  ,numeroProposition = 0;
				  	var  nbElements = (document.getElementById("question" + numeroQuestionNouveau + "proposition" + (numeroProposition + 1) + "_id"  ) == null ) ? 4 : 5;
				  	while( (k + (nbElements - 1) ) <  parametresQuestion.length)//Cette question a des propositions ?
				  	{
					  	numeroProposition++;
					  	...
					  	if( nbElements == 5 )
					  	{
					  		parametresQuestion[k].id = "question" + numeroQuestionNouveau + "proposition" + numeroProposition + "_id";
					  		parametresQuestion[k].name = parametresQuestion[k].id;

						  	parametresQuestion[k + 2].name = "question_proposition_q" + numeroQuestionNouveau + "_g" + i + "_p" + numeroProposition;
						  	parametresQuestion[k + 2].id   = parametresQuestion[k + 2].name;					  	
						  	parametresQuestion[k + 3].name = "question_proposition_score_q" + numeroQuestionNouveau + "_g" + i + "_p" + numeroProposition;
						  	parametresQuestion[k + 3].id   = parametresQuestion[k + 3].name;					  	
						  //parametresQuestion[k + 4] = <script> initArray(3 , 1);</script>
					  	...
					  	k += nbElements;
					  	nbElements = (document.getElementById("question" + numeroQuestionNouveau + "proposition" + (numeroProposition + 1) + "_id") == null ) ? 4 : 5;
				  	}
...
function ajouteQuestion(numeroGroupe)
{
	...
	for(var i = 1 ; i < nbGroupes ; i++)
	{
	  ...
	  for (var j = 2; j < questions.length ; j++) {	  	
		  		...
		  		var numeroQuestionActuelle = questions[j].id.substring(9);
		  		var questionIsInBdd = (document.getElementById("question" + numeroQuestionActuelle + "_id") == null ) ? false : true;
				...
				/*  <input type="radio" id="champ_pas_obligatoire_q3_g2" name="question_obligatoire_q3_g2" value="0"  />  */
			  	...
			  	var k = (z + 1)  ,numeroProposition = 0;
			  	var  nbElements = (document.getElementById("question" + numeroQuestionActuelle + "proposition" + (numeroProposition + 1) + "_id"  ) == null ) ? 4 : 5;
			  	while( (k + (nbElements - 1) ) <  parametresQuestion.length)//Cette question a des propositions ?
			  	{
				  	numeroProposition++;
				  	...
				  	k += nbElements;
				  	nbElements = (document.getElementById("question" + numeroQuestionActuelle + "proposition" + (numeroProposition + 1) + "_id") == null ) ? 4 : 5;
			  	}
...
{	
	var erreurElement = ( document.getElementsByClassName("erreur") != null) ? document.getElementsByClassName("erreur") : new Array();
	var succesElement = ( document.getElementsByClassName("succes") != null) ? document.getElementsByClassName("succes") : new Array();

	for (var i = 0 ; i < erreurElement.length ; i++)
		document.getElementsByTagName("section")[0].removeChild(erreurElement[i]);
	
	for (var i = 0 ; i < succesElement.length ; i++)
		document.getElementsByTagName("section")[0].removeChild(succesElement[i]);
    ...
    var valeurDescription = document.getElementById("description").value;
    	...
    	for(var i = 1 ; i < nbGroupes ; i++)
    	{
    		...
    		{	  	
		  		...
		  		var questionIsInBdd = (document.getElementById("question" + numeroQuestion + "_id") == null ) ? false : true;
		  		
			  	var z;
			  	if(questionIsInBdd)
			  	{
				  	// parametresQuestion[0] = <label>Question n°1 [ X Supprimer de la base de données ] </label> 
				  	//parametresQuestion[1] = <input type="hidden" id="question1_id" name="question1_id" value="96" />
			  		z = 2;
			  	}
			  	else
			  	{
			  	...
			  	/* parametresQuestion[z] - élément <select id="question_type_q1_g1"> */			  	
		        if ( parametresQuestion[z].value == null || parametresQuestion[z].value.trim().length == 0 || parametresQuestion[z].value == "titre")
		        	erreurs[t++] = "<strong>Groupe n°" + i + " Question n°" + numeroQuestion + "</strong> Type de question est un champ obligatoire.";  
		        z++;
		        
				/*  parametresQuestion[z] - <input type="text" id="question_texte_q1_g1" name="question_texte_q1_g1" placeholder="La question présentée aux utilisateurs" /> */
		        if ( parametresQuestion[z].value == null || parametresQuestion[z].value.trim().length == 0)
		        ...
		        /*  parametresQuestion[z + 1] - <label class="label_champ_obligatoire">Champ obligatoire : </label>   */
		        /*  parametresQuestion[z + 2] - <label for="champ_obligatoire_q3_g2">Oui</label>   */		        
				/* parametresQuestion[z + 3] - <input type="radio" id="champ_obligatoire_q3_g2" name="question_obligatoire_q3_g2" value="1" /> */
			  	/* parametresQuestion[z + 4] - <label for="champ_pas_obligatoire_q3_g2">Non</label> */
		        /* parametresQuestion[z + 5] - <input type="radio" id="champ_pas_obligatoire_q3_g2" name="question_obligatoire_q3_g2" value="0"  /> */
		        z += 5;
		        
		        var champObligatoire = document.getElementsByName( parametresQuestion[z].name );
		        ...
		        z++;
			  	/* parametresQuestion[z] - <input type="button" id="question_3_ajouteProposition" value=" + Proposition" onclick="ajouteProposition();" />  */			  	
			  	...
			  	while( (k + (nbElements - 1) ) <  parametresQuestion.length)//Cette question a des propositions ?
			  	{
				  	...
				  	if( nbElements == 5 )
				  	{
				  		//parametresQuestion[k] =  <input type="hidden" id="question1proposition1_id" name="question1proposition1_id" value="97" />
				  		//parametresQuestion[k + 1] = [ X Supprimer la proposition de la base de données ]
				  		
					  	//parametresQuestion[k + 2] - question_proposition
				        if ( parametresQuestion[k + 2].value == null || parametresQuestion[k + 2].value.trim().length == 0 )
					  	...
					  	//parametresQuestion[k + 3] - question_proposition_score
				        if ( parametresQuestion[k + 3].value == null || parametresQuestion[k + 3].value.trim().length == 0 || !Number.isInteger( (parametresQuestion[k + 3].value)*1 ) )
