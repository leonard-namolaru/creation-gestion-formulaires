...
/**
 * <b>La classe UpdateMotDePasseOublie</b>: 
 * <ul>
 * 	<li>Hérite de la classe HTTPSERVLET</li>
 * 	<li>Servlet qui fait l'option "Mot de passe oublié"</li>
 * </ul>
 * 
 ...
 */
public class UpdateMotDePasseOublie extends HttpServlet {
	/* *********************************** ATTRIBUTS ********************************** */
    ...
    public static final String VUE              	= "/ModifierMotDePasse.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(passwordForm.getErreurs().isEmpty()) {
        	// 4; Si envoie reussi -> redirection à la page de connexion
    	    response.sendRedirect(getServletContext().getContextPath() + "/Accueil");
        } else {
        	// 5. Sinon rester sur la page 
