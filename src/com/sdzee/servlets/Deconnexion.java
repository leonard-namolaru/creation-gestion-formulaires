...
/**
 * <b>La classe Deconnexionn</b>: 
 * <ul>
 * 	<li>Hérite de la classe HTTPSERVLET</li>
 * 	<li>Servlet qui permet la déconnexion d'un utilisateur ou administrateurs</li>
 * </ul>
 * 
...
public class Deconnexion extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 2. Destruction de la session en cours 
		request.getSession().invalidate();
		
		// 3. Puis redirection à la page d'accueil 
