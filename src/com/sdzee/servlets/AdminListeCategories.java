 ...
 */
public class AdminListeCategories extends HttpServlet {
	/* *********************************** ATTRIBUTS ********************************** */
	...
	private static final String VUE              	= "/RestreintAdmin/Admin_connecte.jsp";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 2. Affichage des catégorie existante dans la BDD 
		List<Categorie> categories= categorieDao.lister(start, count);
		
		
		// 3. Trouver la liste de réponses de la base de données
		List<Reponse> reponses= reponseDao.lister();
		
		
		// 4. Récupère le message sur l'action supprimer une catégorie
		String message = (String) request.getAttribute("message");
	
		// 5. Stockage des attributs dans l'objet request et transmission à la vue
		...
		request.setAttribute(ATT_CATEGORIE, categories);
