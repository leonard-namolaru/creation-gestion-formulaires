...
/**
 * <b>La classe RetrouverMotDePasse</b>: 
 * <ul>
 * 	<li>Hérite de la classe HTTPSERVLET</li>
 * 	<li>Servlet qui permet de retrouver le mot de passe d'un utilisateur</li>
 * </ul>
 * 
 ...
 * @author Huihui Huang
 */
public class RetrouverMotDePasse extends HttpServlet {
	/* *********************************** ATTRIBUTS ********************************** */
    ...
    private static final String VUE              	= "/MotDePasseOublie.jsp";
    ...
    /**
     * Récupération des instances de notre DAO Utilisateur
     * 
     * @throws ServletException Si erreur pendant la récupération de l'instance
     * 
     * @see UtilisateurDao
     */
	 ...
	 * @see RetrouverMotDePasseForm#TrouverMotDePasse(HttpServletRequest)
	 */
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 1. Préparation de l'objet Retrouver mot de passe
		RetrouverMotDePasseForm passwordForm = new RetrouverMotDePasseForm( utilisateurDao );
		
		// 2. Retrouver son mot de passe 
		Utilisateur utilisateur= passwordForm.trouverMotDePasse(request);
